...
const RegisterForm = () => {
    ...
    const registerFormik = useFormik({
        ...
        onSubmit: values => {
            register(values.firstname, values.email, values.password).then((response: AxiosResponse) => {
                    ...
                    <div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
                        ...
                        <div className="col-span-full sm:col-span-3">
                            ...
                            {registerFormik.touched.password && registerFormik.errors.password ? (
                                <div className="text-red-500 text-xs italic">{registerFormik.errors.password}</div>
                            ) : null}
                        ...
                        <div className="col-span-full sm:col-span-3">
                            ...
                            {registerFormik.touched.confirmPassword && registerFormik.errors.confirmPassword ? (
                                <div className="text-red-500 text-xs italic">{registerFormik.errors.confirmPassword}</div>
                            ) : null}
                ...
                <fieldset className="flex flex-col p-6 rounded-md w-full">
                    ...
                    <div className="col-span-full">
                        ...
                        <div className="flex items-center space-x-2">
                            <img
                                src="https://source.unsplash.com/30x30/?random" alt=""
                                className="w-10 h-10 rounded-full bg-gray-500"
                            />
                            <button type="button" className="px-4 py-2 border rounded-md border-gray-800">
                                Change
                            </button>
                        </div>
                    </div>
